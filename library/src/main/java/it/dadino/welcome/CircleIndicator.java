...
public class CircleIndicator extends LinearLayout {
	...
	private       DataSetObserver      mInternalDataSetObserver    = new DataSetObserver() {
		...
		public void onChanged() {
			...
			int newCount = mViewpager.getAdapter()
			                         .getCount();
	...
	private void handleTypedArray(Context context, AttributeSet attrs) {
		...
		mIndicatorWidth = typedArray.getDimensionPixelSize(R.styleable.CircleIndicator_ci_width,
				-1);
		mIndicatorHeight = typedArray.getDimensionPixelSize(R.styleable.CircleIndicator_ci_height,
				-1);
		...
		mIndicatorBackgroundResId = typedArray.getResourceId(
				R.styleable.CircleIndicator_ci_drawable, R.drawable.white_radius);
	...
	private void createIndicators() {
		removeAllViews();
		int count = mViewpager.getAdapter()
		                      .getCount();
		if (count <= 0) {
			return;
		}
